...
public class OrderItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(order.getStore().getName());
        mAuth = FirebaseAuth.getInstance();
        progressBar = (ProgressBar) findViewById(R.id.progressBar);
        db = FirebaseDatabase.getInstance().getReference().child("Order").child("OrderList").child(mAuth.getCurrentUser().getUid()).child(key).child("store").child("items");
